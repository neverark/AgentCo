...
最新讲解流程与初始成本见 [2–4 分钟演示脚本](demo-walkthrough.zh-CN.md)。
...
本次整个脚本运行在标识清楚的 Demo 模式。现场可重放性来自固定数据与确定性执行；供应商、价格、历史和发现都不应解释为真实样本。实际操作步骤以 [当前演示脚本](demo-walkthrough.zh-CN.md) 为准。
